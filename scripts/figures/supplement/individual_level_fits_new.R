#--- This script relies on the individual level trajectories being
#--- sampled which happens in the Panel B section of the figure_2 script
...
p_ind <- dt_ind_fits_plot[Wave == "XBB wave"] |>
  ...
  facet_wrap(Wave ~ stan_id, scales = "free", ncol = 18)
