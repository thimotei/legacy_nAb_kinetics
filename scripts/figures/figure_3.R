...
dt_figure_3_data[, Wave := fct_relevel(Wave, "Delta wave")]

dt_figure_3_data_plot <- dt_figure_3_data[
  , rel_drop := mu_s/mu_p,
...
dt_figure_3_data_long <- melt(
  dt_figure_3_data,
  measure.vars = process_params,
  variable.name = "parameter")

dt_figure_3_data_long[
...
dt_figure_3_data_long_focal <- dt_figure_3_data_long[Wave_type == "focal"]

dt_figure_3_data_long_sum <- summarise_draws(
  dt_figure_3_data_long_focal,
  column_name = "value",
  by = c("Infection history",
         "Wave_type", "Titre type", "Wave",
         "parameter"))

dt_figure_3_1 <- dt_figure_3_data_long_focal[
...
p_figure_3_2 <- dt_figure_3_2_sum |>
...
figure_3 <- cowplot::plot_grid(p_figure_3, p_figure_3_2, nrow = 2, rel_heights = c(1, 0.6))
