...
model {
  ...
  sigma_t0_ind ~ normal(0, 5);
  sigma_tp_ind ~ normal(0, 7.5);
  sigma_ts_ind ~ normal(0, 12.5);
  sigma_m1_ind ~ normal(0, 5);
  sigma_m2_ind ~ normal(0, 5);
  sigma_m3_ind ~ normal(0, 5);
  ...
  beta_t0 ~ std_normal();
  beta_tp ~ normal(0, 1.5);
  beta_ts ~ normal(0, 2.5);
  beta_m1 ~ std_normal();
  beta_m2 ~ std_normal();
  beta_m3 ~ std_normal();
